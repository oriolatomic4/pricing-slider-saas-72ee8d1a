  ...
  return (
    <div className="relative">
      ...
      <div className={`absolute inset-0 ${
        theme === 'dark' 
          ? 'bg-black bg-gradient-to-br from-vitruve-purple/30 via-black to-vitruve-cyan/30' 
          : 'bg-white bg-gradient-to-br from-vitruve-purple/20 via-white to-vitruve-cyan/20'
      }`} />
      ...
      <div className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center gap-4">
              ...
              <Button size="lg" variant="outline" className={`
                ${theme === 'dark' 
                  ? 'border-vitruve-purple/30 text-vitruve-purple bg-white/10 backdrop-blur-sm hover:bg-vitruve-purple/10 hover:border-vitruve-purple/50'
                  : 'border-vitruve-purple/30 text-vitruve-purple hover:bg-vitruve-purple/10 hover:border-vitruve-purple/50'
                }
              `}>
                Book a Demo
              </Button>
          ...
          <div className="mt-20 text-center">
            <p className={`${theme === 'dark' ? 'text-white/50' : 'text-gray-500'} mb-8 text-xl`}>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-8 items-center justify-items-center">
              <div className={`h-12 w-24 ${theme === 'dark' ? 'bg-white/5' : 'bg-gray-100'} rounded-lg flex items-center justify-center p-2`}>
