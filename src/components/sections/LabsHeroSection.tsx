  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 bg-cover bg-center" style={{
        backgroundImage: 'url("https://images.unsplash.com/photo-1581092947349-3e6db786bc65?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80")'
      }} />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
              <span className="bg-gradient-to-r from-vitruve-purple to-vitruve-cyan bg-clip-text text-transparent">Advanced </span> 
              <span className="text-white">performance</span>
              <br />
              <span className="text-white">analytics </span> 
              <span className="bg-gradient-to-r from-vitruve-cyan to-vitruve-yellow bg-clip-text text-transparent">lab.</span>
            </h1>
            <p className="text-xl text-white/70 max-w-2xl mx-auto mb-8">
              Leverage sports science and data analytics to unlock athlete potential.
              <br />Make informed decisions with comprehensive performance insights.
            </p>
              ...
              <div className="rounded-[1.5rem] overflow-hidden border border-[#333333] shadow-inner bg-[#121212]">
                <div className="h-6 w-full bg-[#0f0f0f] flex items-center justify-between px-4">
                  <div className="flex items-center">
                    ...
                    <div className="text-white/60 text-xs">Vitruve Labs Dashboard</div>
                  </div>
                ...
                <div style={{
                  ...
                  <img 
                    src="/lovable-uploads/2ef15874-d25f-40c0-ae8c-9418dec6b085.png" 
                    alt="Vitruve labs interface" 
