...
export const CartFooter = ({ subtotal, nextPath, onClose }: CartFooterProps) => {
  return (
    <div className="p-5 border-t border-gray-800 dark:border-gray-800 bg-gray-900 dark:bg-gray-900">
      <div className="space-y-2 mb-5">
        ...
        <div className="flex justify-between text-base font-bold pt-2 border-t border-gray-800 dark:border-gray-800">
          <span className="text-gray-200 dark:text-gray-200">Total Due</span>
          <span className="text-white dark:text-white">€{subtotal.toFixed(2)}</span>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <Button
          variant="outline"
          className="w-full text-gray-300 dark:text-gray-300 py-4 border-gray-700 dark:border-gray-700"
          onClick={onClose}
        >
